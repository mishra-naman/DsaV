...
import { addNode, addNodeAt, findNode, getSize, removeNode, reverseList } from '../../../app/services/listSlice';
    ...
    <div className='array-handler-container'>
      ...
      >
        <ul>
          ...
          <li ref={liRef}>
            <button style={{ height: liHeight }} onClick={handleReversal} className='reversal-button'>Reversal</button>
          </li>
        </ul>
      </div>
    </div>
